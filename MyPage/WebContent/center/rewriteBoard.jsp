...
%>
<form action="rewriteBoardPro.jsp" method="post" name="fr" enctype="multipart/form-data" >
...
<input type="hidden" name="re_seq" value="<%=bb.getRe_lev() %>" >
<!-- 답글 input -->
<table>
	<tr>
		<th>제목</th><td><input type="text" name="subject" value="[답글] " ></td>
	</tr>
	<tr>
